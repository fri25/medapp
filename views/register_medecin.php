            ...
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <h3 class="card-title">Inscription Médecin</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="alert alert-info">
                                <p><i class="bi bi-info-circle"></i> Après inscription, vous devrez compléter votre profil professionnel et fournir les pièces justificatives de vos qualifications.</p>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="text-center">
                            ...
                            <p>Vous êtes patient? <a href="register_patient.php">Inscrivez-vous ici</a></p>
                        </div>
                    </div>
                </div>
            </div>
